...
export default function MeasuringTool({ roomName, value, onChange }) {
  ...
  return (
    <div style={{ width: "100%" }}>
      {/* Unit toggle */}
      <div style={{ display: "flex", gap: 0, marginBottom: 20, borderRadius: 8, overflow: "hidden", border: `1px solid ${BORDER}`, alignSelf: "flex-start", width: "fit-content" }}>
        {["m", "ft"].map((u) => (
          <button
            key={u}
            onClick={() => setUnit(u)}
      ...
      {!skip && (
        <>
          <div style={{ display: "grid", gridTemplateColumns: "1fr auto 1fr", gap: 12, alignItems: "center", marginBottom: 20 }}>
            <div>
              <label style={{ display: "block", color: MUTED, fontFamily: "var(--font-outfit)", fontSize: 11, letterSpacing: "0.08em", textTransform: "uppercase", marginBottom: 8 }}>
                Length
              </label>
              <input
                type="number"
            ...
            <div style={{ color: MUTED, fontFamily: "var(--font-outfit)", fontSize: 20, paddingTop: 24 }}>×</div>
            <div>
              <label style={{ display: "block", color: MUTED, fontFamily: "var(--font-outfit)", fontSize: 11, letterSpacing: "0.08em", textTransform: "uppercase", marginBottom: 8 }}>
                Width
              </label>
          ...
          {withWastage && (
            <div style={{
              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                <div>
                  <div style={{ color: MUTED, fontFamily: "var(--font-outfit)", fontSize: 11, letterSpacing: "0.08em", textTransform: "uppercase", marginBottom: 4 }}>
                    Area (inc. 10% wastage)
                  </div>
                  <div style={{ color: TEXT, fontFamily: "var(--font-outfit)", fontWeight: 600, fontSize: 22 }}>
                    {withWastage} m²
                  </div>
                </div>
                <div style={{ textAlign: "right" }}>
                  <div style={{ color: MUTED, fontFamily: "var(--font-outfit)", fontSize: 11, marginBottom: 2 }}>
                    Floor area
                  </div>
                  <div style={{ color: MUTED, fontFamily: "var(--font-outfit)", fontSize: 14 }}>
                    {areaM2} m²
                  </div>
                </div>
              </div>
